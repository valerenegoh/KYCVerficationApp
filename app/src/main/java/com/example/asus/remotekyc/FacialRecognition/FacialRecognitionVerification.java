package com.example.asus.remotekyc.FacialRecognition;
...
public class FacialRecognitionVerification extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
...
//                    }
    ...
    public FacialRecognitionVerification() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.facialrecognition_verification);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(uniqueNames.size() > 0) {
                    Intent intent = new Intent(FacialRecognitionVerification.this, SomeHomePage.class);
                    intent.putExtra("list", uniqueNamesArray);
                    startActivity(intent);
                }
                else {
                    Toast.makeText(FacialRecognitionVerification.this, "Empty list cannot be sent further", Toast.LENGTH_LONG).show();
                }
            }
        });
